...
export default function Navbar() {
  return (
      <Container>
        <div className="flex justify-between items-center pt-12 md:hidden mb-6">
            ...
            <Link href="https://lemo-design.com" target="_self">
              <span className="group flex cursor-pointer transition duration-300 ease-out hover:scale-110">
                <svg
                  ...
                  className="fill-white-alt group-hover:fill-orange-500"
                >
                ...
                <h1 className="h-10 text-sm font-semibold leading-10 text-white-alt group-hover:text-orange-500">
                  Lemo-Design | Blog
                </h1>
              </span>
            </Link>
          ...
          <div className="flex-none">
            <nav className="transform cursor-pointer transition duration-300 ease-out hover:scale-x-125 hover:scale-y-125">
              <Link href="https://lemo-design.com/contact" target="_self">
                <span className="rounded-lg border-2 border-white-alt py-2 px-4 font-semibold leading-10 text-white-alt hover:text-white transition-all hover:border-orange-500 hover:bg-orange-500">
                  Back to website
                </span>
              </Link>
            </nav>
              ...
              <div className="mt-2 flex-auto text-center">
                <nav>
                  <Link href="https://lemo-design.com/showcases" target="_self">
                    <span className="mx-4 cursor-pointer font-light text-sm text-white-alt transition duration-300 ease-in-out hover:border-b-4 hover:border-orange-500">
                      Showcases
                    </span>
                  </Link>
