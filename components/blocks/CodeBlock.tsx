  ...
  const CopyCodeButton = (
    <button
      className={`hidden md:inline-block group ${
        isCopied ? 'text-orange-500' : 'text-warm-gray-500'
      }`}
      onClick={() => handleCopy()}
    >
          ...
          <div className="relative not-prose">
            ...
            >
              <div className="relative flex text-xs leading-6 ">
                <div className="flex items-center flex-none px-4 py-1 mt-2 text-sm text-orange-400 border-t border-b border-t-transparent border-b-orange-400">
                  {caption || JSON.stringify(language).replace(/['"]+/g, '')}{' '}
                </div>
                <div className="flex flex-auto pt-2 overflow-hidden rounded-tr-xl">
                  <div className="flex-auto -mr-px border rounded-tl bg-[#ffffff10] border-[#ffffff10]"></div>
                </div>
