      ...
      >
        <div className="w-full">
          ...
          <input
            {...register('email')}
            type="email"
            className="w-full px-5 py-3 text-base text-gray-900 placeholder-gray-500 border border-transparent rounded-md shadow-xs"
        ...
        <div>
          ...
          <button
            type="submit"
            className="block w-full px-2 py-3 font-medium text-white transform bg-gray-600 border border-transparent rounded-md shadow-sm hover:bg-gray-500 sm:px-6"
          >
